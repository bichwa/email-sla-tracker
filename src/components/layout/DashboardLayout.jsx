                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-gray-900">Email SLA Tracker <span className="text-xs text-primary-600 bg-primary-50 px-2 py-0.5 rounded-full ml-2">v2.3</span></h1>
